      ...
      <div class="card">
        ...
        <div class="card-body no-padding">
          <?php
                ...
                $this->table->set_heading('PaymentID','RegisterID','WorkerID','Type of Payment','Amount','Time of Payment','Entry No','');
                foreach($query as $row){
                    if($_SESSION['status'] == "ADMIN"){
                      $edit = "<a href='".site_url()."/athenaReport/get_entry/".$row->payment_id."' title='".$row->payment_id."'>Print Entry</a>
                      <br>
                    ...
                    $this->table->add_row($row->payment_id, $row->register_id, $row->worker_id, $row->type, $row->amount, $row->time, $row->entry_no,$edit);
                }
